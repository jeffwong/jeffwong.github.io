...
rbind(
  ...
  tab_spanner(label = "Design Inputs", columns = c(ncp, alpha, required_n_c)) %>% 
  tab_style(
    style = cell_borders(
      sides  = "left",
      color  = "black",
...
1. [A Note on Type S/M Errors in Hypothesis Testing](https://www.microsoft.com/en-us/research/wp-content/uploads/2020/09/LuQiuDeng-BJMSP2019.pdf) \\
2. [Beyond Power Calculations: Assessing Type S (Sign) and Type M (Magnitude) Errors](https://sites.stat.columbia.edu/gelman/research/published/retropower_final.pdf) \\
3. [AB Testing Intuition Busters](https://exp-platform.com/abtestingintuitionbusters/)
