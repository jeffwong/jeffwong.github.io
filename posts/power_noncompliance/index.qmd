...
The second term is the variance of a mixture. The mixture has 2 parts: 
$E[y | X = 0] =\mu_0$ and $E[y | X = 1] = \mu_1 = \mu_0 + \Delta$ and each part
is a function of a bernoulli random variable, $X$. We leverage the identity
